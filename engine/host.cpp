...
ConVar host_thread_mode( "host_thread_mode", "1", FCVAR_DEVELOPMENTONLY, "Run the host in threaded mode, (0 == off, 1 == if multicore, 2 == force)");
ConVar host_threaded_sound( "host_threaded_sound", "1", FCVAR_DEVELOPMENTONLY,"Run the sound on a thread (independent of mix)");
ConVar host_threaded_sound_simplethread( "host_threaded_sound_simplethread", "1", FCVAR_DEVELOPMENTONLY, "Run the sound on a simple thread not a jobthread");
